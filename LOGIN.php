    ...
    <div class="background">
        <div class="blur">
            ...
            <div class="bx">
                ...
                <h1 id="H1">Login</h1>
                <div class="box">
                    <form action="/WebTechProject2/LOGIN.php" method="post">
                        ...
                        <div class="input-box">
                          <a href="menu1.php"> <input type="button" value="Login"></a> 
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            <a href="SIGNUP.php"><input type="button" value="NEW USER SIGN UP"></a>
                        </div>
                ...
                <div id="footer">
                    ...
                    <div class="footerEl">
                        ...
                        <div class="SocialMedia ">
                            ...
                            <a href="https://www.instagram.com/"><img class="Social" src="insta.png"
                                    alt="instagram "></a>

                            <a href="https://www.facebook.com "> <img class="Social" src="fb.png" alt="facebook"></a>
                            <a href="https://twitter.com/?lang=en"> <img class="Social" src="twitter.png"
                                    alt="twitter"></a>
